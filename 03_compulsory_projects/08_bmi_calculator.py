...
#     if weight_unit == "gm":
#         weight = st.text_input("Weight (in gm)")  # Text input for weight in grams
#     else:
#         weight = st.text_input("Weight (in kg)")  # Text input for weight in kilograms
...
#     if weight_unit == "gm":
#         weight = float(weight) / 1000  # Convert gm to kg
#     else:
#         weight = float(weight)
